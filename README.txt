...
-A MIPS assembly program coded using Mars simulator to solve a unique first order ordinary differential equation numerically using
Euler's method.
...
-The returned value is kept in $v0 and written in memory address (0x10010000) (first
data address in mars)
-Multiplication function was made using shifting left 
-No pseudo instructions used in this program
-Preservation rules has been followed for saved $s, temporary $t and return address $ra registers on the memory stack.
